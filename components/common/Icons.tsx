...
export const LogoPlaceholder: React.FC<{ className?: string }> = ({ className }) => (
    <div className={`bg-primary-light dark:bg-primary-dark rounded-md flex items-center justify-center ${className}`}>
        <span className="font-serif font-bold text-primary-dark dark:text-primary-light text-lg">ES</span>
    </div>
);
...
export const TwitterIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231L18.244 2.25zM17.5 19.5h1.5l-8.25-10.875h-1.5L17.5 19.5z"></path></svg>
);
