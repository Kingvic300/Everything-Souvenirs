...
const Footer = () => {
     return (
         <footer className="bg-gradient-to-b from-slate-900 to-slate-950 text-white mt-6">
              <div className="max-w-7xl mx-auto pt-3 sm:px-5 lg:pt-4 py-9">
                   <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        <div>
                             <h3 className="text-2xl font-bold mb-4 text-white">Everything Souvenirs</h3>
                        ...
                        <div>
                             ...
                             <form className="flex w-full max-w-sm">
                                  <input
                                      ...
                                      className="w-full px-4 py-2 rounded-l-md bg-slate-800 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-400"
                                  />
                                  <button
                                      type="submit"
                                      className="bg-emerald-500 hover:bg-emerald-600 px-4 py-2 rounded-r-md text-white text-sm font-semibold transition"
                                  >
                                       Subscribe
                                  </button>
                             </form>
