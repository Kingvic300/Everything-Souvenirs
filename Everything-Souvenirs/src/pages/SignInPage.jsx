     ...
     return (
         ...
         >
              ...
              <div className="relative z-10 w-full max-w-2xl sm:max-w-xl backdrop-blur-md bg-black/40 shadow-2xl rounded-3xl p-10 sm:p-12 border border-white/20 text-white">
                   ...
                   <p className="text-base text-center text-gray-200 mb-6">Sign in to unwrap your experience</p>
                   ...
                   <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                             <span className="bg-black/40 px-3 text-gray-300">or sign in with email</span>
                        </div>
                   </div>
