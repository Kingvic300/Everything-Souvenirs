...
import {
    FaUser, FaEnvelope, FaBuilding, FaBoxes, FaCommentDots,
    FaCheckCircle, FaQuoteLeft, FaClock, FaShieldAlt
} from 'react-icons/fa';
...
• Project Details: ${formData.message}
        ...
        const phoneNumber = "2347053531269";
                        ...
                        <div className="bg-white shadow-2xl rounded-3xl p-8 lg:p-10 border border-slate-200">
                            ...
                            {submitted ? (
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="text-2xl font-bold text-slate-900 mb-4">Quote Request Sent via WhatsApp!</h3>
                                    <p className="text-slate-600 text-lg mb-6">
                                        Thank you for your interest! Our team will respond shortly via WhatsApp with a detailed quote.
                                    </p>
                                    <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4">
                                        <p className="text-emerald-700 font-medium">
                                            📱 Please check your WhatsApp for a confirmation message.
                                        </p>
                                    </div>
                                </div>
                            ) : (
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <p className="text-center text-sm text-slate-500 mt-4">
                                        By submitting this form, you agree to be contacted on WhatsApp regarding your quote.
                                    </p>
                                </form>
                            )}
                        </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-slate-600 text-sm">You'll receive a WhatsApp confirmation immediately after submission.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-indigo-200 text-sm">+234 705 353 1269</p>
                                        </div>
                                    </div>
                                </div>
